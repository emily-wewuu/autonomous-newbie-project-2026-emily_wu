...
scenarios = [
    {
        # LIMITATION 3: RIGHT COMMAND DOESN'T STEER CAR QUICKLY ENOUGH TO AVOID OBSTACLE
    ...
    {
        # LIMITATION 1: IF OBSTACLE DISTANCE <= DANGER_DISTANCE AND SPEED > 3.3 IT WILL CRASH INTO OBSTACLE NO MATTER WHAT AS STOP IS NOT REDUCING THE SPEED QUICK ENOUGH
    ...
    {
        # LIMITATION 2:SINCE THE INPUTS DON'T UPDATE, IT WILL JUST KEEP TURNING LEFT
    ...
    {
        # LIMITATION 2: SAME AS ABOVE, DOESN'T UPDATE...
